...
export default function ExpenseList({ expenses, onDelete, onAddClick }: Props) {
        ...
        return (
          <div key={date}>
            ...
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-xs font-medium text-gray-500">{formatCurrency(dayTotal)}</span>
            </div>
              ...
              {items.map((e) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {e.notes && (
                      <p className="text-xs text-gray-400 truncate">{e.notes}</p>
                    )}
                  </div>
